...
#Save Plot
save_plot(filename = "figures/brmps2_plot.pdf",
          plot = brmps2_plot,
          nrow = 1, ncol = 1,
...
#Save Plot
save_plot(filename = "figures/transition_himaize_plot.pdf",
...
#Save Plot
save_plot(filename = "figures/brmps1_plot.pdf",
          plot = brmps1_plot,
          nrow = 1, ncol = 1,
          base_aspect_ratio = 1.1)
...
#Save Plot
save_plot(filename = "figures/himaize_brmps_plot.pdf",
...
#Save Plot
save_plot(filename = "figures/loodat_plot.pdf",
          plot = loodat_plot,
          nrow = 1, ncol = 1,
          base_aspect_ratio = 1.1)
...
save_plot(filename = "figures/wk_3_lactobacillus_plot.pdf",
          plot = wk_3_lactobacillus_plot,
          nrow = 1, ncol = 1,
          base_aspect_ratio = 1.1)
...
save_plot(filename = "figures/wk_3_lactococcus.pdf",
          plot = wk_3_lactococcus_plot,
          nrow = 1, ncol = 1,
          base_aspect_ratio = 1.1)
...
save_plot(filename = "figures/wk_3_lactobacteria_plot.pdf",
          plot = wk_3_lactobacteria_plot,
          nrow = 1, ncol = 1,
          base_aspect_ratio = 1.1)
...
We found that different supplement types do yield different effects on pH in the human gut microbiome and the data also suggests that frequency might also play a role. From our data, BRMPS taken 2 times daily produced the largest decrease in pH in the participants' guts which led us to pursue further statistical analysis concerining individuals who consumed BRMPS twice a day. We found that there was an average increase in the mean abundance of Lacto Bacteria present in their guts, but we could not make any correlations between pH and abundances of Lacto Bacteria, specifically Lactococcus and Lactobacillus. However, Lacto Bacteria have the potential to confer a lot of health benefits such as increased resistance to foreign and harmful bacteria and decreased gut permeability to bacterial toxic biproducts.

This research can definitely be expanded upon as future research should attempt to increase the sample sizes, look at other bacterial species present, species diversity, and experiment with the frequency of which a given supplement is consumed. It is no doubt that these data can serve as a foundation for the expansion upon research with BRMPS as a supplement and possible mechanisms by which BRMPS causes such a drastic mean decrease in pH. Ultimately our conclusions serve as an exciting start towards understanding how to maintain healthy microbial composition.